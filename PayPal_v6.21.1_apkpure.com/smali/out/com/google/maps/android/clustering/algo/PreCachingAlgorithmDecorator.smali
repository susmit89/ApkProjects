...
# instance fields
.field private final a:Lcom/google/maps/android/clustering/algo/Algorithm;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/maps/android/clustering/algo/Algorithm",
            "<TT;>;"
...
.method public constructor <init>(Lcom/google/maps/android/clustering/algo/Algorithm;)V
    ...
    iput-object v0, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->b:Landroid/support/v4/util/LruCache;
    ...
    iput-object v0, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->c:Ljava/util/concurrent/locks/ReadWriteLock;

    .line 40
    iput-object p1, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->a:Lcom/google/maps/android/clustering/algo/Algorithm;
...
.method private a(I)Ljava/util/Set;
    ...
    .prologue
    .line 90
    iget-object v0, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->c:Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    .line 91
    iget-object v0, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->b:Landroid/support/v4/util/LruCache;
    ...
    .line 92
    iget-object v1, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->c:Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    .line 98
    iget-object v0, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->a:Lcom/google/maps/android/clustering/algo/Algorithm;
    ...
    .line 99
    iget-object v1, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->b:Landroid/support/v4/util/LruCache;
...
.method static synthetic a(Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;I)Ljava/util/Set;
    .registers 3

    .prologue
    .line 32
    invoke-direct {p0, p1}, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->a(I)Ljava/util/Set;
...
.method public addItem(Lcom/google/maps/android/clustering/ClusterItem;)V
    ...
    .line 45
    invoke-direct {p0}, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->a()V
...
.method public getClusters(D)Ljava/util/Set;
    ...
    .line 72
    invoke-direct {p0, v0}, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->a(I)Ljava/util/Set;

    move-result-object v1

    .line 74
    iget-object v2, p0, Lcom/google/maps/android/clustering/algo/PreCachingAlgorithmDecorator;->b:Landroid/support/v4/util/LruCache;
