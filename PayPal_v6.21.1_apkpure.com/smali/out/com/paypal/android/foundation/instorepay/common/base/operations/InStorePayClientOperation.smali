.class public abstract Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;
    }
.end annotation
...
# instance fields
.field private final methodStrategy:Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->LOGGER:Lcom/paypal/android/foundation/core/log/DebugLogger;
...
.method protected constructor <init>(Ljava/lang/Class;)V
    ...
    .prologue
    .line 44
    sget-object v0, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;->POST_JSON:Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;

    invoke-direct {p0, p1, v0}, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;-><init>(Ljava/lang/Class;Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;)V

    .line 45
    return-void
.end method

.method protected constructor <init>(Ljava/lang/Class;Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;)V
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 40
    iput-object p2, p0, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->methodStrategy:Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;
...
.method static synthetic access$000()Lcom/paypal/android/foundation/core/log/DebugLogger;
    ...
    .prologue
    .line 32
    sget-object v0, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->LOGGER:Lcom/paypal/android/foundation/core/log/DebugLogger;
...
.method protected getDataRequestWithPath(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Lcom/paypal/android/foundation/core/data/DataRequest;
    ...
    .prologue
    .line 54
    invoke-virtual {p0}, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->getMethodStrategy()Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;

    move-result-object v0

    invoke-interface {v0, p0, p1, p2, p3}, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;->getDataRequest(Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Lcom/paypal/android/foundation/core/data/DataRequest;
...
.method protected getMethodStrategy()Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;
    .registers 2

    .prologue
    .line 81
    iget-object v0, p0, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->methodStrategy:Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$MethodStrategy;
...
.method public getTier()Lcom/paypal/android/foundation/paypalcore/model/AuthenticationTier;
    ...
    .prologue
    .line 49
    sget-object v0, Lcom/paypal/android/foundation/paypalcore/model/AuthenticationTier;->ClientAccessToken:Lcom/paypal/android/foundation/paypalcore/model/AuthenticationTier;
...
.method public operate(Lcom/paypal/android/foundation/core/operations/OperationListener;)V
    ...
    .prologue
    .line 122
    invoke-virtual {p0}, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->shouldTrackWithDiagnostics()Z
    ...
    .line 125
    invoke-virtual {p0}, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;->getEventType()Lcom/paypal/android/nfc/diagnostics/event/EventType;
    ...
    .line 136
    new-instance v0, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$1;

    move-object v1, p0

    move-object v5, p1

    invoke-direct/range {v0 .. v5}, Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation$1;-><init>(Lcom/paypal/android/foundation/instorepay/common/base/operations/InStorePayClientOperation;Lcom/paypal/android/nfc/diagnostics/event/EventType;Ljava/lang/String;Lcom/paypal/android/nfc/NFCManager;Lcom/paypal/android/foundation/core/operations/OperationListener;)V
...
.method public shouldTrackWithDiagnostics()Z
    .registers 2
